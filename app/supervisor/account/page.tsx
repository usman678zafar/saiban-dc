...
export default async function SupervisorAccountPage() {
  ...
  if (!session?.user?.email) redirect('/signin?callbackUrl=/supervisor/account');
  ...
  return (
    ...
    >
      <header className="mb-5 flex flex-col gap-2">
        ...
        <p className="max-w-3xl text-sm leading-6 text-[#5f718a]">Update your supervisor account password.</p>
      </header>
