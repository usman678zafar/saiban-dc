    ...
    >
      <form action="/reviewer" className="mb-4 rounded-lg border border-slate-200 bg-white p-3 shadow-sm">
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          {search ? (
            <Link href="/reviewer" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
      ...
      <div className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
          ...
          <table className="min-w-full text-left text-sm text-slate-700">
            ...
            <tbody>
              {applications.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-4 py-8 text-center text-slate-500">No applications pending reviewer review.</td>
                </tr>
              ) : (
        ...
        <div className="grid gap-3 p-3 md:hidden">
          {applications.length === 0 ? (
            <p className="px-4 py-8 text-center text-sm text-slate-500">No applications pending reviewer review.</p>
          ) : (
            applications.map((application) => (
