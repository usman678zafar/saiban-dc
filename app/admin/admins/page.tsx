  ...
  return (
    <AdminShell email={session.user.email} role={session.user.role}>
      <header className="mb-6 flex flex-col gap-2">
        <h1 className="text-2xl font-semibold tracking-tight text-[#0f1f33] sm:text-3xl">Manage Admins</h1>
        <p className="max-w-3xl text-sm leading-6 text-[#5f718a]">
          Create and maintain admin accounts. Super admin accounts are intentionally not editable here.
        </p>
      </header>
