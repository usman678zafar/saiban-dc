...
import baitussalamLogo from '@/assests/BWT Logo-02.png';
...
const urduFontFamily = '"Saiban Urdu Nastaleeq", "Jameel Noori Nastaleeq", "Noto Nastaliq Urdu", "Segoe UI", Arial, sans-serif';
...
async function renderAttestationPage(data: AttestationFormData, pageNumber: 1 | 2) {
  ...
  try {
    ...
    context.drawImage(baitussalamImage, 1066, 75, 76, 125);
  } catch {
